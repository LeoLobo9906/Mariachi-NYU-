...
export const repertoire: Song[] = [
  ...
  // --- Added from the president's list (2026) ---
  { title: "Ya No Me Interesas", artist: "Lucha Villa", genre: "Ranchera" },
  { title: "A Mi Manera", artist: "Vicente Fernández", genre: "Balada Ranchera" },
  { title: "En el Olvido", artist: "Vicente Fernández", genre: "Ranchera" },
  { title: "Solamente Una Vez", artist: "Agustín Lara", genre: "Bolero" },
  { title: "Himno a la Humildad", genre: "Ranchera" },
  { title: "La Petenera", artist: "Traditional", genre: "Son Jarocho" },
  { title: "La Tequilera", artist: "Lucha Reyes", genre: "Ranchera" },
  { title: "Sin Ti", artist: "Los Panchos", genre: "Bolero" },
  { title: "Sombras, Nada Más", artist: "Javier Solís", genre: "Bolero" },
  { title: "Tragos Amargos", artist: "Cuco Sánchez", genre: "Ranchera" },
  { title: "Sentimiento", genre: "Bolero" },
  { title: "Por un Amor", artist: "Pedro Infante", genre: "Vals" },
  { title: "En mi Viejo San Juan", artist: "Los Panchos", genre: "Bolero" },
  { title: "Jarabe Tapatío", artist: "Mariachi Vargas de Tecalitlán", genre: "Jarabe" },
  { title: "Árboles de la Barranca", artist: "Vicente Fernández", genre: "Ranchera" },
  { title: "La Llorona", artist: "Chavela Vargas", genre: "Son Istmeño" },
  { title: "No Llega El Olvido", artist: "Vicente Fernández", genre: "Ranchera" },
  { title: "Las Alazanas", artist: "Antonio Aguilar", genre: "Corrido" },
  { title: "Te Lo Pido Por Favor", artist: "Juan Gabriel", genre: "Balada Ranchera" },
  { title: "El Preso No. 9", artist: "Traditional", genre: "Corrido" },
  { title: "El Tiempo No Perdona", artist: "Vicente Fernández", genre: "Ranchera" },
];
