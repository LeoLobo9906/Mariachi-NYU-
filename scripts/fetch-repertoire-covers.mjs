...
const SONGS = [
  ...
  ["En el Olvido", "Vicente Fernández"],
  ["Solamente Una Vez", "Agustín Lara"],
  ["Himno a la Humildad", ""],
  ["La Petenera", "Mariachi"],
  ["La Tequilera", "Lucha Reyes"],
  ["Sin Ti", "Los Panchos"],
  ["Sombras, Nada Más", "Javier Solís"],
  ["Tragos Amargos", "Cuco Sánchez"],
  ["Sentimiento", ""],
  ["Por un Amor", "Pedro Infante"],
  ["En mi Viejo San Juan", "Los Panchos"],
  ["Jarabe Tapatío", "Mariachi Vargas de Tecalitlán"],
  ["Árboles de la Barranca", "Vicente Fernández"],
  ["La Llorona", "Chavela Vargas"],
  ["No Llega El Olvido", "Vicente Fernández"],
  ["Las Alazanas", "Antonio Aguilar"],
  ["Te Lo Pido Por Favor", "Juan Gabriel"],
  ["El Preso No. 9", "Mariachi"],
  ["El Tiempo No Perdona", "Vicente Fernández"],
];
